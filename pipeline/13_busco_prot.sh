...
busco -i $CLENT -l $BUSCO_SET -o busco_CLENT_prot -m protein --config $BUSCO_PATH --cpu 12 -f 

busco -i $CRAC -l $BUSCO_SET -o busco_CRAC_prot -m protein --config $BUSCO_PATH --cpu 12 -f 
