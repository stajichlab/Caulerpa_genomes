...
busco -i $INDIR/Caulerpa_lentillifera.spades.ragtag.masked.fasta -l $BUSCO_SET -o busco_CLENT -m genome --config $BUSCO_PATH --cpu 12 

busco -i $INDIR/Caulerpa_racemosa.spades.ragtag.masked.fasta -l $BUSCO_SET -o busco_CRAC -m genome --config $BUSCO_PATH --cpu 12 
