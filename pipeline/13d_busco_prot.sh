#!/bin/bash
##
#SBATCH -o logs/13dbusco_prot_euk.log
#SBATCH -e logs/13dbusco_prot_euk.log
#SBATCH --nodes=1
...
busco -i $CLENT -l $BUSCO_SET -o busco_CLENT_prot_euk_v2 -m protein --config $BUSCO_PATH --cpu 12 -f 

busco -i $CRAC -l $BUSCO_SET -o busco_CRAC_prot_euk_v2 -m protein --config $BUSCO_PATH --cpu 12 -f 
