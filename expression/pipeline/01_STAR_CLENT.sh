#!/usr/bin/bash
#SBATCH -p intel,batch --mem 128gb -N 1 -n 32 --out logs/STAR.CLENT.%a.log
#SBATCH -D /rhome/cassande/shared/projects/Caulerpa/expression
#SBATCH -J calp_CLENT_STAR
...
GENOME=$(realpath data/Caulerpa_lentillifera_v2.scaffolds.fa)
GFF=$(realpath data/Caulerpa_lentillifera_v2.gff3)
GTF=Caulerpa_lentillifera_v2.gtf
